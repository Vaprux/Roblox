--[[
	...
	v1: Changed Color to Red. [120, 10, 10]
...
do -- Load items
    ...
    Folder_2.ImageColor3 = Color3.fromRGB(120, 10, 10)
    ...
    Content.ImageColor3 = Color3.fromRGB(20, 20, 20)
    ...
    Layer.ImageColor3 = Color3.fromRGB(20, 20, 20)
    ...
    ImageLabel.ImageColor3 = Color3.fromRGB(120, 10, 10)
    ...
    Inner.ImageColor3 = Color3.fromRGB(120, 10, 10)
    ...
    Slider_2.BackgroundColor3 = Color3.fromRGB(120, 10, 10)
    ...
    ImageLabel_2.ImageColor3 = Color3.fromRGB(120, 10, 10)
    ...
    Layer_4.ImageColor3 = Color3.fromRGB(120, 0, 0)
    ...
    DropdownOption.Font = Enum.Font.Arial
    ...
    ImageLabel_6.ImageColor3 = Color3.fromRGB(40, 40, 40)
    ...
    Layer_5.ImageColor3 = Color3.fromRGB(20, 20, 20)
    ...
    Content_2.ImageColor3 = Color3.fromRGB(20, 20, 20)
    ...
    Items_4.Active = true
    Items_4.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
    ...
    Inner_2.ImageColor3 = Color3.fromRGB(120, 10, 10)
    ...
    Layer_6.ImageColor3 = Color3.fromRGB(20, 20, 20)
    ...
    Content_3.ImageColor3 = Color3.fromRGB(20, 20, 20)
    ...
    Indicator_2.BackgroundColor3 = Color3.fromRGB(120, 10, 10)
    ...
    Inner_3.ImageColor3 = Color3.fromRGB(120, 10, 10)
...
local library library = {
    new = function(options)
        ...
        options = settings.new({
            ...
            boardcolor = Color3.fromRGB(20, 20, 20),
            rounding = 5,
            animation = 0.1,
            ...
            local types = { } do
                ...
                function types.dropdown(dropdownOptions)
                    ...
                    dropdownOptions = settings.new({
                        ...
                        color = Color3.fromRGB(120, 10, 10),
                        rounding = options.rounding,
                        selectioncolor = Color3.fromRGB(120, 10, 10),
                    ...
                    function self.new(name)
                        ...
                        function dropdownObject.Select()
                            ...
                            for i, v in next, dropdownObjects do
                                ...
                                resize(v.object:GetChildren()[1], { ImageColor3 = Color3.fromRGB(40, 40, 40) }, 0.1)
                            end
                        ...
                        function dropdownObject.Destroy()
                            if dropdownObject.selected then
								inner:FindFirstChild("Value").Text = "[...]"
